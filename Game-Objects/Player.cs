...
public class Player
{
    ...
    public void Render(SpriteBatch spriteBatch)
    {
        ...
        spriteBatch.Draw(TextureBack, Position, null, Color, 0, Vector2.Zero, Scale, SpriteEffects.None, 0);
        spriteBatch.Draw(TextureFront, new Vector2(Position.X + TextureBack.Width * Scale, Position.Y), null, Color, 0, Vector2.Zero, Scale, SpriteEffects.None, 0.2f);
    }
    ...
    public void generatevertices()
    {
        ...
        VerticesTop[0] = new Vector2(Position.X + TextureBack.Width/10*9*Scale, Position.Y);
        VerticesTop[1] = new Vector2(VerticesTop[0].X + TextureBack.Width/10*2*Scale, Position.Y);
        ...
        VerticesBottom[0] = new Vector2(Position.X + TextureBack.Width/10*9*Scale, Position.Y + TextureBack.Height*Scale - 50*Scale);
        VerticesBottom[1] = new Vector2(VerticesBottom[0].X + TextureBack.Width/10*2*Scale, VerticesBottom[0].Y);
        VerticesBottom[2] = new Vector2(VerticesBottom[1].X, Position.Y + TextureBack.Height*Scale);
        VerticesBottom[3] = new Vector2(VerticesBottom[0].X, Position.Y + TextureBack.Height*Scale);
    }
